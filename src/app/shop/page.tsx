...
import { newArrivalsData, relatedProductData, topSellingData, dressStyleData, watchesData } from "@/lib/data/products";
...
import { setCategory, setFilteredProducts, setDressStyle } from "@/lib/features/shop/shopSlice";
...
export default function ShopPage() {
  ...
  // Use filtered products if a category is selected, otherwise use all products
  const displayProducts = filters.category 
    ? filteredProducts 
    : allProducts;
        ...
        <div className="flex md:space-x-5 items-start">
          ...
          <div className="flex flex-col w-full space-y-5">
            ...
            <div className="flex space-x-4 mb-4">
              <button
                className={`px-4 py-2 rounded-lg ${filters.category === null ? 'bg-blue-600 text-white' : 'bg-gray-200 text-black'}`}
                onClick={() => handleCategoryClick(null)}
              >
                All
              </button>
              <button
                className={`px-4 py-2 rounded-lg ${filters.category === 'shoes' ? 'bg-blue-600 text-white' : 'bg-gray-200 text-black'}`}
                onClick={() => handleCategoryClick('shoes')}
              >
                Shoes
              </button>
              <button
                className={`px-4 py-2 rounded-lg ${filters.category === 'clothes' ? 'bg-blue-600 text-white' : 'bg-gray-200 text-black'}`}
                onClick={() => handleCategoryClick('clothes')}
              >
                Shirts
              </button>
              <button
                className={`px-4 py-2 rounded-lg ${filters.category === 'watches' ? 'bg-blue-600 text-white' : 'bg-gray-200 text-black'}`}
...
// } from "@/components/ui/pagination";
// import { useAppSelector, useAppDispatch } from "@/lib/hooks/redux";
// import { setCategory, setFilteredProducts } from "@/lib/features/shop/shopSlice";
// import { filterProducts } from "@/lib/utils/filterProducts";
// import { useEffect, useMemo } from "react";
...
//     if (hasActiveFilters) {
//       // Add mock attributes if needed
//       const productsWithAttributes = allProducts.map((product, index) => ({
//         ...product,
//         colors: product.colors || (index % 2 === 0 ? ["white", "black"] : ["blue", "red"]),
//         sizes: product.sizes || (index % 3 === 0 ? ["S", "M"] : ["L", "XL"]),
//         brand: product.brand || ["Nike", "Adidas", "Puma", "Reebok"][index % 4],
//       }));
