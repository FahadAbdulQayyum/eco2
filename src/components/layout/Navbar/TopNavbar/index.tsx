          ...
          {isAuthenticated && currentUser ? (
            <div className="relative ml-3">
              <button
                ...
                title="User menu"
              >
                <div className="w-8 h-8 rounded-full bg-gradient-to-br from-blue-600 to-blue-700 flex items-center justify-center text-white text-sm font-semibold shadow-sm">
              ...
              {/* User dropdown menu */}
              {showUserMenu && (
                <div className="absolute right-0 top-full mt-2 w-56 bg-white rounded-xl shadow-xl border border-gray-100 py-3 z-50">
            ...
            <Link href="/signin" className="p-1 ml-3">
              <Image
                priority
                src="/icons/user.svg"
                height={100}
